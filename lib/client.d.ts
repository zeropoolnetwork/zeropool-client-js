...
export declare class ZeropoolClient {
    ...
    deposit(tokenAddress: string, amountWei: bigint, sign: (data: string) => Promise<string>, fromAddress?: string | null, // this field is only for substrate-based network,
    feeWei?: bigint, outputs?: Output[]): Promise<string>;
