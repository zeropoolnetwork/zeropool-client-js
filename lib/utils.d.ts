...
export declare function ethAddrToBuf(address: string): Uint8Array;
export declare function hexToBuf(hex: string, bytesCnt?: number): Uint8Array;
...
export declare function addressFromSignature(signature: string, signedData: string): string;
